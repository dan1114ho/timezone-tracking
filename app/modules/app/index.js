...
import TimezonesPage from './record/pages/TimezonesPage';
import TimezoneEditPage from './record/pages/TimezoneEditPage';
  ...
  adminRoutes() {
    return (
      <Switch>
        ...
        <Route exact path="/records" component={TimezonesPage} />
        <Route exact path="/records/:id" component={TimezoneEditPage} />
